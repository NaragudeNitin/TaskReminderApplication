...
class TaskScreen extends StatelessWidget {
  ...
  // WidgetBuildBottomSheet(BuildContext conext){
  //   return Container(
  //     child: const Center(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
     ...
     onPressed: () { 
      // showModalBottomSheet(context: context, builder: WidgetBuildBottomSheet(context));
     ...
     body: Column(
      ...
      children: <Widget>[
       Container(
        padding:  const EdgeInsets.only(top: 35, left: 30.0, bottom: 30.0, right: 30.0),
         child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
